...
toc:
  - id: summary
    title: "핵심 요약"
  - id: behavior-signal
    title: "행동 변화는 원인이 아니라 신호일 수 있다"
  - id: pain-expression
    title: "통증은 말 이외의 방식으로도 나타난다"
  - id: sensory-conditions
    title: "감각 조건도 함께 확인해야 한다"
  - id: diagnostic-overshadowing
    title: "진단적 가림을 경계해야 한다"
  - id: check-order
    title: "직접 묻고 점검하는 순서"
  - id: contextual-record
    title: "기록은 당사자의 설명을 돕는 자료다"
  - id: conclusion
    title: "결론"
sources:
  - title: "The Phenomenon of Pain in Adults With Intellectual Disability: A Qualitative Systematic Review"
    organization: "McGuire et al."
    year: "2025"
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC12243444/"
  - title: "The reported expression of pain and distress by people with an intellectual disability"
    organization: "Findlay et al."
    year: "2013"
    url: "https://pubmed.ncbi.nlm.nih.gov/22957760/"
...
## 행동 변화는 원인이 아니라 신호일 수 있다 {#behavior-signal}
...
## 통증은 말 이외의 방식으로도 나타난다 {#pain-expression}
...
## 감각 조건도 함께 확인해야 한다 {#sensory-conditions}
...
## 진단적 가림을 경계해야 한다 {#diagnostic-overshadowing}
...
## 기록은 당사자의 설명을 돕는 자료다 {#contextual-record}
