...
seo:
  ...
  search_intent: "성인 발달장애인이 실제로 배우고 싶다고 답한 내용과 보호자가 희망한 교육을 구분해 평생교육 프로그램의 우선순위를 알고 싶다."
...
toc:
  ...
  - id: survey-scope
    title: "누가 답한 조사인가"
  - id: learner-answers
    title: "당사자가 배우고 싶다고 답한 것"
  - id: guardian-answers
    title: "보호자가 희망한 교육"
  - id: interpretation
    title: "수치를 읽을 때 주의할 점"
  - id: program-design
    title: "평생교육 프로그램에 주는 질문"
  - id: conclusion
    title: "결론"
sources:
...
---
성인 발달장애인은 무엇을 배우고 싶어 할까. **성인 발달장애인 평생교육 수요**와 **발달장애인 교육 수요**를 말할 때 기관이 공급하는 프로그램 목록만 보면 당사자가 원하는 배움을 놓칠 수 있다. 한국장애인고용공단 고용개발원의 「2025년 발달장애인 일과 삶 실태조사」는 당사자에게 직접 물은 답과 보호자가 답한 교육 의향을 함께 보여 준다.[1](#source-1)

이 조사의 발달장애인은 등록 지적장애인과 자폐성장애인 등을 포괄하는 넓은 범주다. 따라서 이 글은 두 집단을 포괄한 조사 결과를 설명하며, 모든 개인의 선호가 같다고 보거나 지적장애인만의 수치로 바꾸어 말하지 않는다. **성인 발달장애 학습**을 설계할 때도 이 범위를 먼저 확인해야 한다.
...
## 당사자가 배우고 싶다고 답한 것 {#learner-answers}
...
## 평생교육 프로그램에 주는 질문 {#program-design}
